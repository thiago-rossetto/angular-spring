...
import com.thiago.crudspring.dto.mapper.CourseMapper;
...
public class CourseService {
    ...
    public CourseDTO update(
        ...
        return courseRepository.findById(id)
            .map(courseFinded -> {
                courseFinded.setName(course.name());
                courseFinded.setCategory(course.category());
                return courseMapper.toDTO(courseRepository.save(courseFinded));
            })
            .orElseThrow(() -> new RecordNotFoundException(id));
    }
